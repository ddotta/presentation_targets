...
subtitle: "Créer des chaînes de traitements reproductibles avec R"
date: today
...
- Représenter les étapers d'une chaîne de traitement sous forme de *pipeline*  
- Facilier la prise en main par autrui  
...
<br>
=> Dans le dossier `_targets/object`, le fichier sera stocké au forma exigé.
...
- Comme targets conserve une copie des résultats des cibles en **cache**, pas besoin de tout recalculer quand on relance le projet, on peut récupérer *µµ**directement les résultats et savoir si ils sont à jour**.  
